###### 支持的组件：
```php
field($name, $label = '', $cloSize = 12)
text($name, $label = '', $cloSize = 12)
checkbox($name, $label = '', $cloSize = 12)
radio($name, $label = '', $cloSize = 12)
button($type, $label = '', $cloSize = 12)
select($name, $label = '', $cloSize = 12)
multipleSelect($name, $label = '', $cloSize = 12)
textarea($name, $label = '', $cloSize = 12)
hidden($name)
color($name, $label = '', $cloSize = 12)
rangeSlider($name, $label = '', $cloSize = 12)
file($name, $label = '', $cloSize = 12)
image($name, $label = '', $cloSize = 12)
date($name, $label = '', $cloSize = 12)
datetime($name, $label = '', $cloSize = 12)
time($name, $label = '', $cloSize = 12)
year($name, $label = '', $cloSize = 12)
month($name, $label = '', $cloSize = 12)
dateRange($name, $label = '', $cloSize = 12)
datetimeRange($name, $label = '', $cloSize = 12)
timeRange($name, $label = '', $cloSize = 12)
number($name, $label = '', $cloSize = 12)
switchBtn($name, $label = '', $cloSize = 12)
rate($name, $label = '', $cloSize = 12)
divider($text, $label = '', $cloSize = 12)
password($name, $label = '', $cloSize = 12)
decimal($name, $label = '', $cloSize = 12)
html($html, $label = '', $cloSize = 12)
raw($name, $label = '', $cloSize = 12)
show($name, $label = '', $cloSize = 12)
tags($name, $label = '', $cloSize = 12)
icon($name, $label = '', $cloSize = 12)
multipleImage($name, $label = '', $cloSize = 12)
multipleFile($name, $label = '', $cloSize = 12)
wangEditor($name, $label = '', $cloSize = 12)
tinymce($name, $label = '', $cloSize = 12)
ueditor($name, $label = '', $cloSize = 12)
editor($name, $label = '', $cloSize = 12)
ckeditor($name, $label = '', $cloSize = 12)
mdeditor($name, $label = '', $cloSize = 12)
match($name, $label = '', $cloSize = 12)
matches($name, $label = '', $cloSize = 12)
//特殊组件
tab
step
fields
